...
namespace WebApplication1.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            // Se chegamos até aqui, algo falhou, então redisplay do formulário
            return Page();
        }
        ...
        private IdentityUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Não foi possível criar uma instância de '{nameof(IdentityUser)}'. " +
                    $"Verifique se '{nameof(IdentityUser)}' não é uma classe abstrata e possui um construtor sem parâmetros, ou alternativamente " +
        ...
        private IUserEmailStore<IdentityUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("A interface padrão requer um armazenamento de usuários com suporte a e-mail.");
            }
