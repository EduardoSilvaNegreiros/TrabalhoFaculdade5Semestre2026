...
namespace WebApplication1.Data.Migrations
{
    ...
    [Migration("20260603001951_FinalMarketplaceImprovements")]
    partial class FinalMarketplaceImprovements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Models.CarrinhoPersistidoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("UsuarioEmail", "ProdutoId")
                        .IsUnique();

                    b.ToTable("CarrinhoPersistidoItens");
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.ComissaoCategoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("ComissoesCategoria");
                });

            modelBuilder.Entity("WebApplication1.Models.ListaDesejosItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("ListaDesejosItens");
                });

            modelBuilder.Entity("WebApplication1.Models.Lojista", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("WebApplication1.Models.PedidoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("ValorRepasseLojista")
                        .HasPrecision(10, 2)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("WebApplication1.Models.Produto", b =>
                {
                    ...
                    b.Property<string>("CurvaturaCachos")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("WebApplication1.Models.PedidoItem", b =>
                {
                    b.HasOne("WebApplication1.Models.Lojista", "Lojista")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplication1.Models.Produto", b =>
                {
                    b.HasOne("WebApplication1.Models.Categoria", "CategoriaRelacionada")
                        .WithMany("Produtos")
