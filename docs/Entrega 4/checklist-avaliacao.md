...
- [x] Strategy aplicado em recomendação de produtos.
- [x] Facade aplicado no checkout.
- [x] Factory Method aplicado na escolha do provedor de IA.
- [x] Cada padrão possui nome, categoria, problema resolvido, UML e trecho de código no relatório.
...
- [x] Uso de IA descrito: recomendador de produtos de beleza.
...
Observação: conferência realizada em 31/05/2026; histórico visível mostra commits associados a Eduardo / Eduardo Silva de Negreiros.
