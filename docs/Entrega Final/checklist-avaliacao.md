...
- [x] Roteiro cobre modelo de negocio e proposta de valor.
- [x] Roteiro cobre demonstracao do prototipo Figma.
- [x] Roteiro cobre arquitetura C4 e modelo de dados.
- [x] Roteiro cobre API documentada.
- [x] Roteiro cobre funcionalidade de IA.
- [x] Roteiro cobre conclusao e aprendizados.

## 2. Repositorio GitHub final

- [x] Repositorio GitHub final registrado no README da raiz.
- [x] README.md da raiz atualizado com descricao, integrantes, tecnologias, execucao e links principais.
- [x] Pasta `/docs` organizada com Entregas 1, 2, 3, 4 e Entrega Final.
- [x] Entrega 1 documentada com relatorio, PDF e checklist.
- [x] Entrega 2 documentada com relatorio, PDF, Figma e checklist.
...
- [x] Atividade 0: formacao do grupo registrada.
- [x] Entrega 1: Concepcao do projeto documentada.
